...
// Initials avatar generator: monochrome navy bg with white letters — NO stock photos.
function Avatar({ name, accent }) {
  ...
  return (
    <div className="relative h-56 w-full overflow-hidden rounded-lg" style={{ background: `linear-gradient(135deg, ${c}, #0A1F44)` }}>
